...
class LocalizationTests: XCTestCase {
    func test_infoPlist_localizedStrings_haveKeysAndValuesForAllSupportedLocalizations() {
        let table = "InfoPlist"
        let presentationBundle = Bundle.main
    ...
    func test_localizable_localizedStrings_haveKeysAndValuesForAllSupportedLocalizations() {
